...
Функция ТипЛюбаяСсылка(ВключатьПеречисления = Истина) Экспорт
	ОписаниеТипов = Новый ОписаниеТипов;
	ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, ПланыОбмена, Метаданные.ПланыОбмена);
	ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, Справочники, Метаданные.Справочники);
	ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, Документы, Метаданные.Документы);
	Если ВключатьПеречисления Тогда
		ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, Перечисления, Метаданные.Перечисления);
	КонецЕсли;
	ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, ПланыВидовХарактеристик,
		Метаданные.ПланыВидовХарактеристик);
	//
	ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, ПланыСчетов, Метаданные.ПланыСчетов);
	ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, ПланыВидовРасчета, Метаданные.ПланыВидовРасчета);
	ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, БизнесПроцессы, Метаданные.БизнесПроцессы);
	ОписаниеТипов = ДополнитьОписаниеТиповСсылками(ОписаниеТипов, Задачи, Метаданные.Задачи);
	Возврат ОписаниеТипов;
КонецФункции

Функция ДополнитьОписаниеТиповСсылками(ОписаниеТипов, Менеджер, ОбъектыМетаданных)
	ДобавляемыеТипы = Неопределено;
	Если РежимСовместимостиКонфигурации >= 3.20 Тогда
		ДобавляемыеТипы = Менеджер.ТипВсеСсылки().Типы();
	Иначе
		ДобавляемыеТипы = Новый Массив;
		Для Каждого ОбъектМетаданных Из ОбъектыМетаданных Цикл
			ИмяТипа = СтрЗаменить(ОбъектМетаданных.ПолноеИмя(), ".", "Ссылка.");
			ДобавляемыеТипы.Добавить(Тип(ИмяТипа));
		КонецЦикла;
	КонецЕсли;
	
	Возврат Новый ОписаниеТипов(ОписаниеТипов, ДобавляемыеТипы);
КонецФункции
...
Версия = "1.7"; // <ВСТАВКА ПАТЧ-ВЕРСИИ>
