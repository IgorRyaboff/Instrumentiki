...
Процедура СписокИнформационныхБазПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	Иначе
		...
		ОткрытьФорму(Объект.ИмяМетаданныхОбработки + ".Форма.АдминистрированиеСервера_ИБ", ПараметрыФормы,,,,, ОповещениеОЗавершении);
...
Процедура НачатьАвторизованноеДействиеСИБ(ИмяИБ, Действие)
	...
	ОткрытьФорму(Объект.ИмяМетаданныхОбработки + ".Форма.АдминистрированиеСервера_АвторизацияВИБ", ПараметрыФормы,,,,, ОповещениеОЗавершении);
КонецПроцедуры
