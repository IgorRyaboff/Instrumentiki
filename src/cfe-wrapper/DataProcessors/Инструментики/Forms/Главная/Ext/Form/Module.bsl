...
Процедура ВыполнитьКоманду(ИдентификаторКоманды, ОбъектыНазначенияМассив) Экспорт
	Если ИдентификаторКоманды = "ОткрытьОбъектВРедактореОбъектов" Тогда
		...
		ОткрытьФорму(Объект.ИмяМетаданныхОбработки + ".Форма.РедакторОбъектов", ПараметрыФормы);
	ИначеЕсли ИдентификаторКоманды = "СравнитьОбъекты" Тогда
		...
		ОткрытьФорму(Объект.ИмяМетаданныхОбработки + ".Форма.СравнениеРеквизитовОбъектов", ПараметрыФормы);
	КонецЕсли;
КонецПроцедуры
...
Процедура СписокИнструментовВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ОткрытьФорму(Объект.ИмяМетаданныхОбработки + ".Форма." + ТД.ИмяФормы);
КонецПроцедуры
