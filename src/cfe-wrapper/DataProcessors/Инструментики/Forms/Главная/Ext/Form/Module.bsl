...
Процедура ЗаполнитьСписокИнструментов()
	...
	Инструмент = СтрокиГруппы.Добавить();
	Инструмент.Наименование = "Консоль веб-сервисов";
	Инструмент.ИмяФормы = "КонсольВебСервисов";
	...
	Инструмент = СтрокиГруппы.Добавить();
	Инструмент.Наименование = "Групповое изменение реквизитов";
	Инструмент.ИмяФормы = "ГрупповоеИзменениеРеквизитов";
