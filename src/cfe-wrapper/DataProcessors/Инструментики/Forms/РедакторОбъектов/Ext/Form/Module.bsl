...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОписаниеТиповЛюбаяСсылка = МодульОбъекта.ТипЛюбаяСсылка(Ложь);
	Элементы.Ссылка.ОграничениеТипа = ОписаниеТиповЛюбаяСсылка;
...
Асинх Процедура ОткрытьРеквизитВРедактореАсинх(Значение)
	...
	Если Не ЗначениеЗаполнено(Значение) Или Не ОписаниеТиповЛюбаяСсылка.СодержитТип(ТипЗнч(Значение)) Тогда
