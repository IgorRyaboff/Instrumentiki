...
Функция СведенияОВнешнейОбработке() Экспорт
	ПараметрыРегистрации = Вычислить("ДополнительныеОтчетыИОбработки.СведенияОВнешнейОбработке(""3.1.7.226"")");

	ПараметрыРегистрации.Наименование = "Инструментики";
	ПараметрыРегистрации.Информация = "Рябов Игорь, 2024";
	ПараметрыРегистрации.Версия = Версия;
	ПараметрыРегистрации.БезопасныйРежим = Ложь;
	ПараметрыРегистрации.Вид = Вычислить("ДополнительныеОтчетыИОбработкиКлиентСервер.ВидОбработкиЗаполнениеОбъекта()");
	...
	НоваяКоманда.Использование = Вычислить("ДополнительныеОтчетыИОбработкиКлиентСервер.ТипКомандыОткрытиеФормы()");
	НоваяКоманда.Представление = НСтр("ru='Открыть Инструментики'");
	
	НоваяКоманда = ПараметрыРегистрации.Команды.Добавить();
	НоваяКоманда.Идентификатор = "ОткрытьОбъектВРедактореОбъектов";
	НоваяКоманда.Использование = Вычислить("ДополнительныеОтчетыИОбработкиКлиентСервер.ТипКомандыВызовКлиентскогоМетода()");
