...
Процедура РеквизитыОбъектаВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле = Элементы.РеквизитыОбъектаИмяТипаЗначения Тогда
		СтандартнаяОбработка = Ложь;
		ВыбратьТипЗначенияАсинх(ТекДанные);
	ИначеЕсли Поле = Элементы.РеквизитыОбъектаЗначение И ТекДанные.ТолькоПросмотр Тогда
...
Асинх Процедура ВыбратьОбъектИзПримитивнойФормыВыбора(Команда)
	...
	ОткрытьФорму("ВнешняяОбработка.Инструментики.Форма.РедакторОбъектов_ФормаВыбора", ПараметрыФормы,,,,, ОповещениеОЗакрытии);
КонецПроцедуры
